      ...
      <Timeline color={theme.colors.primary[6]} active={5} bulletSize={28} lineWidth={2}>
        <Timeline.Item bullet={<IconGitPullRequest size={16} />} title="Pull Request Created">
          <Text color="dimmed" size="sm">
            ...
            the developer has sufficient karma points in their account.
          </Text>
          <Text size="xs" mt={4}>
            Step 1
          </Text>
        ...
        <Timeline.Item bullet={<IconMoneybag size={17} />} title="Karma points Deducted">
          <Text color="dimmed" size="sm">
            The required karma points are deducted from the PR creator's balance. The PR check
            passes, allowing the review process to begin.
          </Text>
          <Text size="xs" mt={4}>
            Step 2
          </Text>
        ...
        <Timeline.Item bullet={<IconBrain size={16} />} title="AI Analysis">
          <Text color="dimmed" size="sm">
            Our AI analyzes the PR's complexity to determine appropriate karma values and identify
        ...
        <Timeline.Item bullet={<IconBubbleText size={16} />} title="PR Reviewed">
          <Text color="dimmed" size="sm">
            Team members review the PR. The AI evaluates review quality to determine fair karma
        ...
        >
          <Text color="dimmed" size="sm">
            Karma rewards are credited to reviewers' accounts based on review quality and PR
            complexity. Bonus karma points are awarded for detecting critical issues.
          </Text>
          <Text size="xs" mt={4}>
            Step 5
          </Text>
