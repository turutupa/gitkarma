...
export type TRepo = {
  ...
  timely_review_bonus_enabled: boolean; // enable timely review bonus
  timely_review_bonus: number; // bonus debits for timely review
  timely_review_bonus_hours: number; // hours for timely review
